...
WebUI.rightClick(findTestObject('Object Repository/Page_CURA Healthcare Service/div_Login                Please login to ma_5151a8'))

WebUI.click(findTestObject('Object Repository/Page_CURA Healthcare Service/label_Username'))

WebUI.click(findTestObject('Object Repository/Page_CURA Healthcare Service/label_Password'))

WebUI.click(findTestObject('Object Repository/Page_CURA Healthcare Service/label_Username'))

WebUI.rightClick(findTestObject('Object Repository/Page_CURA Healthcare Service/button_Login'))
...
WebUI.takeElementScreenshot(findTestObject('Page_CuraAppointment/chk_Medicaid'))

WebUI.takeFullPageScreenshot()

WebUI.takeElementScreenshot(findTestObject('Page_CuraAppointment/div_Appointment'))
